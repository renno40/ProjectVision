        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              subtitle: Text('+1 90211 44 44', style: TextStyle(fontSize: size.width * 0.045)),
            ...
            _buildSettingTile(context, icon: Icons.notifications, color: Colors.orange, title: 'Notifications', subtitle: 'Newsletter, App Updates', onTap: _showNotificationDialog),
            _buildSettingTile(context, icon: Icons.logout, color: Colors.blue, title: 'Logout', onTap: () => _showLogoutConfirmationDialog(context)),
            _buildSettingTile(context, icon: Icons.delete, color: Colors.red, title: 'Delete Account', onTap: () => _showDeleteAccountDialog(context)),
          ],
        ),
      ),
    );
  ...
  Widget _buildGradientBubble(double size, List<Color> colors) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: colors.last.withOpacity(0.4), blurRadius: 12, offset: Offset(4, 4))],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: ListTile(
        leading: Container(
          width: size.width * 0.18,
          height: size.width * 0.18,
          decoration: BoxDecoration(color: color.withAlpha(50), borderRadius: BorderRadius.circular(30)),
              ...
              content: Column(
                ...
                children: [
                  SwitchListTile(
                    ...
                    onChanged: (value) => setState(() => receiveAppUpdates = value),
                  ),
                  SwitchListTile(
                    title: const Text('Newsletter'),
                    value: receiveNewsletter,
                    onChanged: (value) => setState(() => receiveNewsletter = value),
                  ),
                ],
              ),
              actions: [
